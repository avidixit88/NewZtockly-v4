...
def compute_scalp_signal(
    ...
    *,
    ...
    if pro_mode:
        ...
        if not pro_trigger:
            return SignalResult(symbol, "NEUTRAL", int(max(long_points, short_points)), "Pro mode: no divergence / sweep / ORB / OB / breaker trigger", None, None, None, None, last_price, last_ts, session, extras)
